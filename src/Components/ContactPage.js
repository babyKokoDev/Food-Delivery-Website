  ...
  return (
    ...
    <div className='max-w-[800px] bg-white mx-auto p-10 mb-20 rounded-[20px] shadow-lg shadow-black/20'>
         ...
         <div className='mt-5'>
            ...
            <textarea placeholder='message' className='rounded-[20px] px-5 py-4 bg-[#D9D9D9] w-full' name="" id="" cols="30" rows="10"></textarea>  
         </div>
         <div>
            <button className='bg-[#D75127] w-[174px] text-center border-none text-white mt-5 rounded-none py-2 ms-3'>Submit</button>
         </div>
    </div>
    <Footer />
    </>
